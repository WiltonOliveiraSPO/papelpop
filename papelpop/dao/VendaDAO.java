...
/**
 * Representa a classe VendaDAO e centraliza suas responsabilidades no sistema PapelPop.
...
public class VendaDAO {
    ...
    // Ação: executa a rotina 'salvarVenda' desta classe.
    public void salvarVenda(Venda venda) throws SQLException {
        salvarVendaRetornandoId(venda);
    }

    // Ação: executa a rotina 'salvarVendaRetornandoId' desta classe.
    public int salvarVendaRetornandoId(Venda venda) throws SQLException {
    ...
    // Ação: executa a rotina 'listarItens' desta classe.
